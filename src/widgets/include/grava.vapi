/* grava.vapi generated by valac 0.11.1.20-80830, do not modify. */
...
namespace Grava {
	...
	public class Graph {
		...
		public void update ();
		public Graph.with_layout (Grava.Layout layout);
	}
	[CCode (cheader_filename = "grava.h")]
	...
	[CCode (ref_function = "grava_node_row_ref", unref_function = "grava_node_row_unref", cheader_filename = "grava.h")]
	...
	[CCode (cheader_filename = "grava.h")]
	public class TreeLayout : Grava.Layout {
		public TreeLayout ();
		public override void run (Grava.Graph graph);
		public override void set_graph (Grava.Graph graph);
	}
	[CCode (cheader_filename = "grava.h")]
	public class Widget : Gtk.VBox {
